 ...
 * @author Logan Walsh
 * @date 2022-11-09
 * @brief Employee Salary Calculator
 * 
 ...
 *
 * @param Employee & e The name of the employee
 * @pre Runs with each test
 * @return void returns nothing
 * @post the employee's information should be written in and printed
 * 
 */
